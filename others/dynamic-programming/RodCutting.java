...
class Driver {
    ...
    public static void main(String[] args) {
        ...
        int profit = RodCutting.profitRecursive(cost, cost.length);
        System.out.println("Max profit: ");
        System.out.println("Recursive : " + RodCutting.profitRecursive(cost, cost.length));
        System.out.println("Recursive : " + RodCutting.tabular(cost, cost.length));
    }
}
